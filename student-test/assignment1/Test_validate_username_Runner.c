...
int Test_validate_username_main(void)
{
  UnityBegin("/home/vboxuser/Desktop/Advanced_embedded/A1/assignment-1-sath9795/aesd-assignments/assignment-autotest/../student-test/assignment1/Test_validate_username.c");
