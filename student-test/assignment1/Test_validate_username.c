...
void test_validate_my_username()
{
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE(my_username(), malloc_username_from_conf_file(), "Username from autotest-validate.c and username-from-conf-file.h do not match!");
